...
- Primitive recursiveness, partial recursiveness, and primitive recursiveness of the partial definitions are defined
- The runtime of a computatation ϕ_e is defined
- Basic lemmata about the above are proven

**W as a Sequence**
- W e s is the list of elements for which ϕ_{e,s} halts, *in the order that they halted*
